...
from pydantic import create_model, Field, field_validator, FieldValidationInfo

from .types import Array
from .basemodels import ExtendedConfigDict, ProtoModel
from .common_models import DriverEnum, Model, Provenance
from .molecule import Molecule
from .results import AtomicResultProtocols
...
# ManyBodySpecification(SpecificationBase):
